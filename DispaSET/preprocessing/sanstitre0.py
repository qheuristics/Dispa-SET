# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 18:01:05 2018
...
def load_config_heat_excel(ConfigFile_heat):
    """
    Function that loads the DispaSET excel config file and returns a dictionary
    with the values
    ...
    """
    import xlrd
    wb = xlrd.open_workbook(filename=ConfigFile_heat)  # Option for csv to be added later
    sheet = wb.sheet_by_name('main')
    ...
    config_heat['Portofolio']['Solar']= sheet.cell_value(39, 2)
    config_heat['Portofolio']['Winon']= sheet.cell_value(40, 2)
    config_heat['Portofolio']['Winoff']= sheet.cell_value(41, 2)
    config_heat['Portofolio']['Biomass']= sheet.cell_value(42, 2)
