...
def DispOptim(sets, parameters, LPFormulation=False):
    ...
    # 5) Hourly demand balance in the downwards reserve market 2U for each node
    ###################################################################################################################################################################################################################################################################
    ...
    # 6) Hourly demand balance in the downwards reserve market 2D for each node
    ###################################################################################################################################################################################################################################################################
