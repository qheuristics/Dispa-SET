...
POSITIVE VARIABLES
************************************Modification********************************
Load_HP(u,h)               [MW]    Power output

Q_dot(u,h)                 [MW]    Heat output
********************************************************************************
...
;
*- StorageInput(chp,i)*HeatSlack(chp,i)
...
************************************Modification********************************
*** Heat generation ***
EQ_HEAT_HP(heat,i)$(HEATType(heat,'hp'))..
         Load_HP(heat,i) * COP(heat,i)
         =E=
         Q_dot(heat,i)
;
********************************************************************************
...
************************************Modification********************************
OutputLoad_HP(heat,i)=Load_HP.L(heat,z);
OutputCOP(heat,i) =COP.L(heat,z);
OutputQ_dot(heat,i)=Q_dot.L(heat,z);
********************************************************************************
OutputCommitted(u,z)=Committed.L(u,z);
OutputFlow(l,z)=Flow.L(l,z);
OutputPower(u,z)=Power.L(u,z);
OutputHeat2(chp,z)=Heat2.L(chp,z);
